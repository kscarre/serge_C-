...
<form method="post">
	<table>
		<tr><td>Login</td><td><input type = "texte" name = "loginmed" value = ""></td></tr>
		<tr><td>Password</td><td><input type = "password" name = "passwormed" value = ""></td></tr>
		<tr><td colspan ="2" align = "right"><input type = "submit" name = "medok" value = "Entre"> </td></tr>
	</table>
</form>
...
<form method="post">
	<table>
		<tr><td>Login</td><td><input type = "texte" name = "loginpat" value = ""></td></tr>
		<tr><td>Password</td><td><input type = "password" name = "passwordpat" value = ""></td></tr>
		<tr><td colspan ="2" align = "right"><input type = "submit" name = "patok" value = "Entre"> </td></tr>
	</table>
